...
main (int argc, char* argv[])
{
  ...
  output.str ("");
  output << B;
  printTestResult ("Erase Range", "[ 15 ]", output);
  ...
  C.transfer(B.begin(), C.begin(), C.end());
  
  output.str ("");
  output << B;
  printTestResult ("Transfer", "[ 5 10 15 20 15 5 10 ]", output);
  ...
  output.str("");
  output << C;
  printTestResult ("Reverse", "[ 10 5 15 20 15 10 5 ]", output);
